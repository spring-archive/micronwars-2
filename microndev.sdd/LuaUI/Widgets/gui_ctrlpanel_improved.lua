...
function widget:Initialize()
	...
	if (X == 800 and Y == 600) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.044", "yIconSize 0.0586", "yPos 0.14" }
	elseif (X == 1024 and Y == 768) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.0435", "yIconSize 0.0580", "yPos 0.13"}
	elseif (X == 1152 and Y == 864) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.0435", "yIconSize 0.0580", "yPos 0.13"}
	elseif (X == 1280 and Y == 800) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.036", "yIconSize 0.0576", "yPos 0.13"}
	elseif (X == 1280 and Y == 960) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.041", "yIconSize 0.0546", "yPos 0.11"}
	elseif (X == 1280 and Y == 1024) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.042", "yIconSize 0.0525", "yPos 0.12"}
	elseif (X == 1440 and Y == 900) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.035", "yIconSize 0.056", "yPos 0.1"}
	elseif (X == 1600 and Y == 1200) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.042", "yIconSize 0.056", "yPos 0.1"}
	elseif (X == 1680 and Y == 1050) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.035", "yIconSize 0.056", "yPos 0.1"}
	elseif (X == 1920 and Y == 1200) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.035", "yIconSize 0.056", "yPos 0.1"}
	elseif (X == 1920 and Y == 1080) then
		config = {"xIcons 6", "yIcons 11", "xIconSize 0.044", "yIconSize 0.0586", "ypos 0.08"}
	else
